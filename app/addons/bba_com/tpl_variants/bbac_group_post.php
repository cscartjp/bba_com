...
$mail_tpl_var = [
    ...
    'BBA_COM_GROUP_URL' =>
        [
            'desc' => 'bba_com.notify_group_url',
            'value' => empty($_edit_mail_tpl) ? $tpl_email_data['notify_group_url'] : ''
        ],
    //グループ名
    'BBA_COM_GROUP_NAME' =>
        [
            'desc' => 'bba_com.notify_group_name',
            'value' => empty($_edit_mail_tpl) ? $tpl_email_data['group_name'] : ''
        ],
